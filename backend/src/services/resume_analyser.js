...
// Load data files
const onetData = JSON.parse(fs.readFileSync(path.join(__dirname, '../data/results.json'), 'utf-8'));
const roleMap = JSON.parse(fs.readFileSync(path.join(__dirname, '../data/roleMap.json'), 'utf-8'));
