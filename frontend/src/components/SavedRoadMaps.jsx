...
function SavedRoadMaps() {
    ...
    console.log("Saved Roadmaps:", savedRoadmaps[3].roadmap); // Log the saved roadmaps for debugging
    return (
                            ...
                            <tbody>
                                {savedRoadmaps.map((el, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <button className="view-btn" onClick={() => navigate('/roadmap', { state: el.roadmap })}>
                                                View
                                            </button>
                                        </td>
                                    </tr>
