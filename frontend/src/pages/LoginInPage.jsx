        ...
        <div className='login-page'>
            ...
            {authView === "forgot-password" && (
                <div className="forgot-password-container">
                    ...
                    >
                        <div className="form-group">
                            <label htmlFor="email-verification" className="required">Email Address</label>
            ...
            {authView === "otp-verification" && (
                <div className="otp-verification-container">
                    ...
                    <form className="otp-verification-form" onSubmit={(e) => {
                        e.preventDefault();
                    }}
                    >
                        <div className="form-group">
            ...
            {authView === "reset-password" && (
                <div className="reset-password-container">
                    ...
                    >
                        ...
                        <div className='form-group'>
                            <label htmlFor="confirm-new-password" className="required">Confirm New Password</label>
                            <div className="input-wrapper">
                                <Lock size={18} className="input-icon" />
                                <input
                                    type="password"
